...
public abstract class VacuumWorldAbstractCommunicativeAction extends VacuumWorldAbstractAction implements
		CommunicativeAction<VacuumWorldCommunicativeActionsEnum> {
