...
/**
 * 
 * Implementation of {@link VacuumWorldGridPerceptionInterface} and
 * {@link EnvironmentAppearance}.
 * 
...
public class VacuumWorldEnvironmentAppearance implements EnvironmentAppearance, VacuumWorldGridPerceptionInterface {
    ...
    /**
     * 
     * Constructs a {@link VacuumWorldEnvironmentAppearance} from a {@link Map} from
     * {@link VacuumWorldCoordinates} to {@link VacuumWorldLocation} representing
     * the grid.
     * 
     * @param grid
     *                 a {@link Map} from {@link VacuumWorldCoordinates} to
    ...
    @Override
    public Set<VacuumWorldLocationAppearance> getAllNonEmptyLocations() {
	return ImmutableSet.copyOf(this.grid.values().stream().filter(VacuumWorldLocationAppearance::isNotEmpty).collect(Collectors.toSet()));
    }
    ...
    @Override
    public boolean doesSuchLocationExistInPerception(VacuumWorldCoordinates coordinates) {
    ...
    @Override
    public boolean isThereACleaningAgentForward(String id) {
	VacuumWorldCoordinates coordinates = getForwardCoordinates(id);
	
	return doesSuchLocationExistInPerception(coordinates) && this.grid.get(coordinates).isACleaningAgentThere();
    }

    @Override
    public boolean isThereACleaningAgentOnTheLeft(String id) {
	VacuumWorldCoordinates coordinates = getLeftCoordinates(id);
    ...
    @Override
    public boolean isThereACleaningAgentOnTheRight(String id) {
	VacuumWorldCoordinates coordinates = getRightCoordinates(id);
    ...
    @Override
    public boolean isThereACleaningAgentOnForwardLeft(String id) {
	VacuumWorldCoordinates coordinates = getForwardLeftCoordinates(id);
    ...
    @Override
    public boolean isThereACleaningAgentOnForwardRight(String id) {
	VacuumWorldCoordinates coordinates = getForwardRightCoordinates(id);
    ...
    @Override
    public boolean isThereAUserForward(String id) {
	VacuumWorldCoordinates coordinates = getForwardCoordinates(id);
	
	return doesSuchLocationExistInPerception(coordinates) && this.grid.get(coordinates).isAUserThere();
    }

    @Override
    public boolean isThereAUserOnTheLeft(String id) {
	VacuumWorldCoordinates coordinates = getLeftCoordinates(id);
    ...
    @Override
    public boolean isThereAUserOnTheRight(String id) {
	VacuumWorldCoordinates coordinates = getRightCoordinates(id);
    ...
    @Override
    public boolean isThereAUserOnForwardLeft(String id) {
	VacuumWorldCoordinates coordinates = getForwardLeftCoordinates(id);
    ...
    @Override
    public boolean isThereAUserOnForwardRight(String id) {
	VacuumWorldCoordinates coordinates = getForwardRightCoordinates(id);
	...
	this.grid.entrySet().stream().forEach(e -> b.append(e.getKey()).append("->").append(e.getValue().toSimpleString()).append(", "));
	
	return b.length() > 0 ? b.substring(0, b.length() - 3) : "";
    }
}