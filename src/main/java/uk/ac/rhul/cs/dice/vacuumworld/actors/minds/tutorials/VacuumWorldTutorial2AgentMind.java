...
public class VacuumWorldTutorial2AgentMind extends VacuumWorldAbstractMind {
    private static final long serialVersionUID = -2708996373371056961L;
    //Add any class attribute you want/need.

    public VacuumWorldTutorial2AgentMind(String bodyId) { //Add any additional parameter you need.
	super(bodyId);
