...
/**
 * 
 * Implementation of {@link Appearance},
 * {@link VacuumWorldLocationPerceptionInterface}, and {@link Comparable} (with
...
public class VacuumWorldLocationAppearance implements Appearance, VacuumWorldLocationPerceptionInterface, Comparable<VacuumWorldLocationAppearance> {
    ...
    /**
     * 
     * Constructs a {@link VacuumWorldLocationAppearance} from the
     * {@link VacuumWorldCoordinates}, the {@link Appearance} of an
     * {@link ActiveBody}, a {@link VacuumWorldDirtAppearance} and the
     * {@link Boolean} flags for the walls.
     * 
     * @param coordinates
     *                                 the {@link VacuumWorldCoordinates}.
     * @param activeBodyAppearance
     *                                 the {@link Appearance} of an
     *                                 {@link ActiveBody}.
     * @param dirtAppearance
     *                                 a {@link VacuumWorldDirtAppearance}.
     * @param walls
     *                                 the {@link Boolean} flags for the walls
    ...
    /**
     * 
     * Returns whether this {@link VacuumWorldLocation} <code>x</code> coordinate is
     * smaller, equal, or bigger that <code>other</code>'s <code>x</code>
     * coordinate.
     * 
     * @return whether this {@link VacuumWorldLocation} <code>x</code> coordinate is
     *         smaller, equal, or bigger that <code>other</code>'s <code>x</code>
     *         coordinate.
     * 
     */
	...
	return obj instanceof VacuumWorldLocationAppearance && checkFields((VacuumWorldLocationAppearance) obj);
    }
    ...
    /**
     * 
     * Serializes this {@link VacuumWorldLocationAppearance} to a
     * {@link JsonObject}.
     * 
     * @return the {@link JsonObject} serialization of this
     *         {@link VacuumWorldLocationAppearance}.
     * 
     */
    @Override
