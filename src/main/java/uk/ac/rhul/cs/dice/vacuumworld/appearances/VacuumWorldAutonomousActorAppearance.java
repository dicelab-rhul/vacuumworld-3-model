...
public class VacuumWorldAutonomousActorAppearance implements ActorAppearance, VacuumWorldActorAppearance {
	...
	public VacuumWorldAutonomousActorAppearance(String id, AgentColor color, ActorType type, Orientation orientation,
			VacuumWorldMindAppearance mindappearance, List<Sensor> sensors, List<Actuator> actuators) {
		this.id = id;
